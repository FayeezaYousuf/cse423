...
def update_coins():
    ...
    for coin in coins:
        ...
        coin["x"] = coin["x"] + (coin["direction"] * coin_speed) #for animation
...
def draw_road():
    ...
    draw_line(-250, -200, 250, -200,5)  # Top border
    draw_line(-250, -105, 250, -105,5)
    draw_line(-250, -10, 250, -10,5)
    draw_line(-250, 85, 250, 85,5)
    draw_line(-250, 180, 250, 180,5)    # Bottom border
    ...
    for i in range(-250,250,70):
        draw_line(i,-152.5,i + length,-152.5,10)
        draw_line(i, -57.5, i + length, -57.5,10)
        draw_line(i, 37.5, i + length, 37.5,10)
        draw_line(i, 132.5, i + length, 132.5,10)
...
def draw_cat():
    ...
    # Tail part (x is like S and y is for length)
    tail_points = [
        (cat_x, cat_y - 10),
        (cat_x + 2, cat_y - 15),
        (cat_x, cat_y - 20),
